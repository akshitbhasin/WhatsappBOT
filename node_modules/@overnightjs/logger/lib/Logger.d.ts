import { ICustomLogger, LoggerModeOptions } from './constants';
export declare class Logger {
    private static _mode;
    private static _filePath;
    private static _rmTimestamp;
    private static _customLogger;
    private _mode;
    private _filePath;
    private _rmTimestamp;
    private _customLogger;
    private static readonly CUSTOM_LOGGER_ERR;
    constructor(mode?: LoggerModeOptions, filePath?: string, rmTimestamp?: boolean, customLogger?: ICustomLogger);
    private static initFilePath;
    private static initMode;
    private static initRmTimestamp;
    static get mode(): LoggerModeOptions;
    static set mode(mode: LoggerModeOptions);
    get mode(): LoggerModeOptions;
    set mode(mode: LoggerModeOptions);
    static get filePath(): string;
    static set filePath(filePath: string);
    get filePath(): string;
    set filePath(filePath: string);
    static get rmTimestamp(): boolean;
    static set rmTimestamp(rmTimestamp: boolean);
    get rmTimestamp(): boolean;
    set rmTimestamp(rmTimestamp: boolean);
