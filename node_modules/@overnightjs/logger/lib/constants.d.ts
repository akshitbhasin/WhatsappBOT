export declare const DEFAULT_LOG_FILE_NAME = "overnight.log";
...
export declare type LoggerModeOptions = LoggerModes.Console | LoggerModes.File | LoggerModes.Custom | LoggerModes.Off;
